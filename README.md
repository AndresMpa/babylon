...
The aim of this repository is to have a set of tools for myself (Or you) to keep checking them, in order to remember of find topic. I'm also adding a reference list for tools I found useful.
...
- [A set of python questions](https://www.clcoding.com/2025/07/python-coding-challange-question-with_28.html?m=1)
...
- [About Solid principles](https://dev.to/alisamirali/mastering-solid-principles-1aa6)
...
- [Index of functions - AMPGO](https://infinity77.net/global_optimization/genindex.html)
...
- [A guide to build agents](https://blog.langchain.com/how-to-build-an-agent/)
- [AI based tool to interact with Databases/Data](https://www.opensourceprojects.dev/post/1953659743924629927)
